    ...
    <>
      ...
      <section className="film-card">
        <div className="film-card__bg">
          <img src={props.promoMovie.images.bgImg} alt={props.promoMovie.title}/>
        </div>
        ...
        <div className="film-card__wrap">
          <div className="film-card__info">
            <div className="film-card__poster">
              <img src={props.promoMovie.images.posterImg} alt={props.promoMovie.title} width="218" height="327"/>
            </div>

            <div className="film-card__desc">
              <h2 className="film-card__title">{props.promoMovie.title}</h2>
              <p className="film-card__meta">
                <span className="film-card__genre">{props.promoMovie.meta.genre}</span>
                <span className="film-card__year">{props.promoMovie.meta.year}</span>
              </p>
